class CfgVehicles
{
	...
	class IND_Box_Base;
	class Mavic_Item_Box: IND_Box_Base
	{
		author = "$STR_Mavic_Author";
		class SimpleObject
		{
	...
	class Mavic_Item_Box_3E_BLUFOR: Mavic_Item_Box
	{
		hiddenSelections[] = {"Camo_Signs","Camo"};
		hiddenSelectionsTextures[] = {"Mavik\AmmoBox_signs_DRONE_CA.paa","A3\Weapons_F\Ammoboxes\data\AmmoBox_CO.paa"};
	...
	class Mavic_Item_Box_3T_BLUFOR: Mavic_Item_Box_3E_BLUFOR
	{
	...
	class Mavic_Item_Box_3T_CSAT: Mavic_Item_Box_3E_CSAT
	{
	...
	class Mavic_Item_Box_3T_AAF: Mavic_Item_Box_3E_AAF
	{
	...
	class Mavic_Item_Box_3T_CIV: Mavic_Item_Box_3E_CIV
	{
